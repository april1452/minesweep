...
/**
 * This class represents a block of tiles that are known to contain a
 * certain number of mines. As such, it contains a set of tiles and an
 * integer of mines contained. These sets can then have other sets be
 * "subtracted" from it to simplify the blocks and localize the mines.
...
public class MineBlock {
  ...
  /**
   * Creates a MineBlock that represents a certain number of mines
   * contained in a set of tiles.
   * @param tiles A Set containing Tile objects that have the possibility
   *        of having a mine.
   ...
   * @param block2 A MineBlock to check if it is contained in the current
   *        one.
